...
type
  ...
  private
    ...
    procedure SetBtnColorDisabled(Value: TColor);
  ...
  published
    ...
    property BtnColor: TColor read fEnabledBtnColor write SetBtnColor;
...
procedure TSizeCtrl.SetBtnColor(Value:TColor);
begin
  fEnabledBtnColor:=Value;
  UpdateBtnCursors;
end;
//------------------------------------------------------------------------------

procedure TSizeCtrl.SetBtnColorDisabled(Value:TColor);
begin
  fDisabledBtnColor:=Value;
  UpdateBtnCursors;
end;
//------------------------------------------------------------------------------
